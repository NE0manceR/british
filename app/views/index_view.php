	...
	<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<div class="banner" style='background-image: url("<?= SERVER_URL?>style/images/home/carousel-img.png") ;'>
			...
			<div class="row mx-0">
				<div class="col-lg-10">
					...
					<div class='mapWrap position-relative'>
						...
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" class="loc1  wow bounceInDown animate__delay-2s" alt="map">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" class="loc2 wow bounceInDown animate__delay-2s" alt="map">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc3 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc4 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc5 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc6 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc7 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc8 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc9 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc10 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc11 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc12 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc13 wow bounceInDown animate__delay-2s ">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc14 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc15 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc16 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc17 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc18 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc19 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc20 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc21 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc22 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc23 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc24 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc25 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc26 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc27 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc28 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc29 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc30 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc31 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc32 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc33 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc34 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc35 wow bounceInDown animate__delay-2s">
						<img src="<?= SERVER_URL ?>style/img/ei_location.png" alt="map" class="loc36 wow bounceInDown animate__delay-2s">
					...
					<div class="card_list1">
						<div class="cart">
							<div class="cart_wrapper">
								<img src="<?= SERVER_URL ?>style/img/serge.png" alt="">
								<div class="text brd">
									<div class="h7 mb-2">
										Serge G.
									</div>
							...
							<div class="col-sm-2 col-md-1 flagGroup col-12 order-sm-last order-first ">
								<div class="row">
									<div class="d-flex col-sm-12 col-2 jusify-content-end">
										<img src="<?= SERVER_URL ?>style/images/england.png" alt="">

									</div>
									<div class="d-flex col-sm-12 col-2 jusify-content-end">

										<img src="<?= SERVER_URL ?>style/images/scotland.png" alt="">
									</div>
									<div class="d-flex col-sm-12 col-2 jusify-content-end">
										<img src="<?= SERVER_URL ?>style/images/netherlands.png" alt="">

									</div>
									<div class="d-flex col-sm-12 col-2 jusify-content-end">
										<img src="<?= SERVER_URL ?>style/images/belgium.png" alt="">

									</div>
									<div class="d-flex col-sm-12 col-2 jusify-content-end">
										<img src="<?= SERVER_URL ?>style/images/flag-italy.png" alt="">
