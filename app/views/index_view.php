...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
	<div class="carousel-indicators">
		...
		?>
			<button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="<?= $count ?>" class=" sliderRound <?= $key == "section_1" ? "active" : "" ?>" <?= $key == `aria-current='true'` ? "active" : ""  ?> aria-label="Slide <?= $count ?>"></button>
		<?php $count++;
		} ?>
	</div>
...
<div id="carouselExampleIndicators1" class="carousel slide" data-bs-ride="carousel">
	<div class="carousel-indicators">
		...
		foreach ($_SESSION['alias']->section as $key => $value) {
		?>
			<button type="button" data-bs-target="#carouselExampleIndicators1" data-bs-slide-to="<?= $count1 ?>" class=" sliderRound <?= $key == "section_1" ? "active" : "" ?>" <?= $key == `aria-current='true'` ? "active" : ""  ?> aria-label="Slide <?= $count1 ?>"></button>
		<?php $count1++;
		} ?>
	</div>
	<div class="carousel-inner">
