                    ...
                    <div class="row g-0 row-top">
                        ...
                        <div class="burger-menu">
                            ...
                            <ul id="test" class="burger-menu_nav">
                                ...
                                <li id="menu-item-255" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-255"><a href="<?= SITE_URL ?>products/zyma/" class="menu-image-title-after menu-image-not-hovered"><img width="29" height="29" src="<?= SERVER_URL ?>style/img/uploads/2022/01/MaskGroupjnjvg3.png" class="menu-image menu-image-title-after" alt="" loading="lazy"><span class="menu-image-title-after menu-image-title">Зима</span></a></li>
                                <li id="menu-item-256" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-256"><a href="<?= SITE_URL ?>products/vesna/" class="menu-image-title-after menu-image-not-hovered"><img width="26" height="26" src="<?= SERVER_URL ?>style/img/uploads/2022/01/MaskGroup2vdef.png" class="menu-image menu-image-title-after" alt="" loading="lazy"><span class="menu-image-title-after menu-image-title">Весна</span></a></li>
                                <li id="menu-item-257" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-257"><a href="<?= SITE_URL ?>products/lito/" class="menu-image-title-after menu-image-not-hovered"><img width="29" height="29" src="<?= SERVER_URL ?>style/img/uploads/2022/01/MaskGrouprvvf.png" class="menu-image menu-image-title-after" alt="" loading="lazy"><span class="menu-image-title-after menu-image-title">Літо</span></a></li>
                                <li id="menu-item-258" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-258"><a href="<?= SITE_URL ?>products/osin/" class="menu-image-title-after menu-image-not-hovered"><img width="24" height="24" src="<?= SERVER_URL ?>style/img/uploads/2022/01/MaskGroup1vdd.png" class="menu-image menu-image-title-after" alt="" loading="lazy"><span class="menu-image-title-after menu-image-title">Осінь</span></a></li>
